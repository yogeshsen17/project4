...
<body>
	...
	<form action="<%=ORSView.PRESCRIPTION_LIST_CTL%>" method="post">
		...
		<center>
			...
			<table width="100%" align="center">
				<tr>
					<th></th>
					<td align="center"><label>PrescriptionName</font> :
					</label> <input type="text" name="Name"
						placeholder="Enter Prescription Name"
						value="<%=ServletUtility.getParameter("Name", request)%>">
						<label>Prescription Date</font> :
					</label><input type="text" name="Date" placeholder="Enter Date"
 ...
 --%> &nbsp; <input type="submit" name="operation"
						value="<%=PrescriptionListCtl.OP_SEARCH%>"> &nbsp; <input
